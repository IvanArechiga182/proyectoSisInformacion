...
public class productos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        campoEstadoProducto = new javax.swing.JTextField();
        ...
        jScrollPane1.setBounds(240, 70, 770, 430);
        ...
        btnAgregarProducto.setBackground(new java.awt.Color(166, 201, 64));
        btnAgregarProducto.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        btnAgregarProducto.setForeground(new java.awt.Color(255, 255, 255));
        btnAgregarProducto.setText("Agregar");
        btnAgregarProducto.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 202, 100), 2, true));
        ...
        btnEditarProducto.setBackground(new java.awt.Color(124, 154, 44));
        ...
        btnEditarProducto.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 202, 100), 2, true));
        ...
        btnEliminarProducto.setBackground(new java.awt.Color(5, 96, 75));
        btnEliminarProducto.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        btnEliminarProducto.setForeground(new java.awt.Color(255, 255, 255));
        btnEliminarProducto.setText("Eliminar");
        btnEliminarProducto.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 202, 100), 2, true));
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(campoPrecioProducto, javax.swing.GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE)
                            .addComponent(jLabel6)
                            .addComponent(campoEstadoProducto)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(jLabel6)
                .addGap(18, 18, 18)
                .addComponent(campoEstadoProducto, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jLabel7)
                .addGap(18, 18, 18)
    ...
    private void btnEliminarProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarProductoActionPerformed
       ...
       objetoProducto.eliminarProductos(campoIdProducto);
       objetoProducto.mostrarProductos(tablaProductos);
    ...
    private void btnAgregarProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarProductoActionPerformed
        // TODO add your handling code here:
        CProductos objetoProducto = new CProductos();
        objetoProducto.insertarProducto(campoNombreProducto, campoPrecioProducto, campoEstadoProducto, campoCategoriaProducto);
        objetoProducto.mostrarProductos(tablaProductos);
    ...
    private void btnEditarProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarProductoActionPerformed
        // TODO add your handling code here:
       CProductos objetoProducto = new CProductos();
       objetoProducto.modificarProductos(campoIdProducto, campoNombreProducto, campoPrecioProducto, campoEstadoProducto, campoCategoriaProducto);
       objetoProducto.mostrarProductos(tablaProductos);
    ...
    private void tablaProductosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaProductosMouseClicked
        // TODO add your handling code here:
        CProductos objetoProducto = new CProductos();
        objetoProducto.seleccionarProductos(tablaProductos, campoIdProducto, campoNombreProducto, campoPrecioProducto, campoEstadoProducto, campoCategoriaProducto);
    ...
    private javax.swing.JTextField campoEstadoProducto;
