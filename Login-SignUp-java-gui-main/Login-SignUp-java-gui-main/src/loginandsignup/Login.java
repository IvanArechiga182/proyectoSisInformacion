...
public class Login extends javax.swing.JFrame {
 ...
 connection cx;
    ...
    private void initComponents() {
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/leaves.jpg"))); // NOI18N
        jLabel8.setText("jLabel3");
        jPanel1.add(jLabel8);
        jLabel8.setBounds(430, -60, 440, 620);
    ...
    private void btnIniciarSesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIniciarSesionActionPerformed
     try {
         ...
         String query = "SELECT * FROM usuarios WHERE nombre_usuario='"+usuario+"' and contraseña='"+pass+"'";
